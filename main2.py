...
title.grid(row=0, columnspan=4, padx=180, pady=40)
...
btn_tree = Button(btn_frame, command=exit, text="EXIT", width=15, font=("calibri", 10, "bold"), bg="white",
                  fg="dodgerblue4", bd=0)
btn_tree.grid(row=0, column=5, padx=10, pady=10)

btn_compound = Button(btn_frame, command=back, text="BACK", width=15, font=("calibri", 10, "bold"),
                      bg="white", fg="dodgerblue4", bd=0)
